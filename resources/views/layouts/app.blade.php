...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('css/style_registro.css')?>" />
...
<header>
    <nav class="var">
      ...
      <ul class="nav-links">
        ...
        <li class="tr">
          <a class="subrayado" href="">Regístrate</a>
        </li>
        <li class="tr">
          <a href="" class="button-primary" style="font-size: 17px">Iniciar Sesión</a>
        </li>
      </ul>
